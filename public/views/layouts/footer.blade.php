      ...
      <div class="flex flex-wrap justify-between items-center mt-8">
        ...
        <div class="w-full md:w-1/2 text-right">
          <form class="flex items-center">
            <input type="email" placeholder="Subscribe to our newsletter" class="px-4 py-2 rounded-l bg-gray-700 text-white focus:outline-none">
            <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded-r hover:bg-green-600 hover:shadow-lg">Subscribe</button>
          </form>
        </div>
      </div>
      <div class="text-center mt-8">
        <p class="text-gray-400">© 2024 Eduflow. All rights reserved.</p>
      </div>
    </div>
</footer>