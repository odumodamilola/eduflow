    ...
    <main>
        ...
        <section class="pt-[327px] xl:pt-[287px] lg:pt-[237px] sm:pt-[200px] xxs:pt-[180px] pb-[158px] xl:pb-[118px] lg:pb-[98px] sm:pb-[68px] xs:pb-[48px] text-center bg-[url('{{asset('img/breadcrumb-bg.jpg')}}')] bg-no-repeat bg-cover bg-center relative z-[1] overflow-hidden before:absolute before:-z-[1] before:inset-0 before:bg-edblue/70 before:pointer-events-none">
            ...
            <div class="vectors">
                <img src="{{asset('img/breadcrumb-vector-1.svg')}}" alt="vector" class="absolute -z-[1] pointer-events-none bottom-[34px] left-0 xl:left-auto xl:right-[90%]">
                <img src="{{asset('img/breadcrumb-vector-2.svg')}}" alt="vector" class="absolute -z-[1] pointer-events-none bottom-0 right-0 xl:right-auto xl:left-[60%]">
            </div>
        </section>
        ...
        <section class="py-[120px] xl:py-[80px] md:py-[60px]">
            <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                <div class="flex sm:flex-col items-start justify-between gap-[15px]">
                    <h2 class="ed-section-title">About the Eduflow</h2>
                    ...
                    <div class="max-w-[50%] sm:max-w-full mb-[60px]">
                        ...
                        <a href="#" class="font-medium text-edpurple inline-flex items-center gap-[10px] border-b border-edpurple">Overview <span class="icon"><img src="{{asset('img/icon/arrow-up-right.svg')}}" alt="icon"></span></a>
                    </div>
                </div>

                <div class="flex items-center">
                    <div class="md:w-[10%] xxs:w-[5%]">
                        <img src="{{asset('img/about-inner-img.jpg')}}" alt="About image" class="w-[633px] max-w-[633px] sm:max-w-[308px] aspect-[633/431px]">
                    </div>
                    ...
                    <div class="md:w-[90%] xxs:w-[95%]">
                        <div class="bg-white p-[50px] lg:p-[30px] xxs:p-[20px] shadow-[0_4px_25px_rgba(0,0,0,0.06)] -ml-[92px] xl:-ml-[134px] lg:-ml-[278px] md:ml-0">
                            <h6 class="font-semibold uppercase text-edpurple relative z-[1] pl-[40px] mb-[10px] before:absolute before:left-0 before:top-[50%] before:-translate-y-[50%] before:h-[1px] before:w-[30px] before:bg-edpurple">About Eduflow</h6>
                            <h4 class="font-semibold text-[30px] md:text-[26px] xs:text-[22px] leading-[1.2] mb-[26px]">WE SUPPORT YOUR AMBITION</h4>
                            <ul class="ed-inner-about-list font-medium text-[16px] text-edgray grid grid-cols-[repeat(2,max-content)] xs:grid-cols-1 gap-x-[30px] xxs:gap-x-[15px] gap-y-[9px] mb-[37px] *:pl-[25px] *:relative *:before:absolute *:before:left-0 *:before:top-[4px] *:before:w-[15px] *:before:aspect-square *:before:bg-[url({{asset('img/icon/checkmark.svg')}})] *:before:bg-no-repeat *:before:bg-[length:15px_13px] *:before:bg-center">
                            ...
                            <div class="flex flex-wrap items-center gap-x-[24px] gap-y-[20px]">
                                <div class="flex gap-x-[8px]">
                                    <div class="rounded-full overflow-hidden w-[58px] aspect-square shrink-0">
                                        <img src="{{asset('img/user.png')}}" alt="Principal" class="w-[58px] aspect-square">
                                    </div>
                                    <div>
                                        <h5 class="font-semibold text-[18px] text-black mb-[4px]">Ronald Richards</h5>
                                        <h6 class="text-edgray">Principal <span class="text-edpurple">Eduflow</span></h6>
                                    </div>
                                </div>
        ...
        <section class="bg-[#FAF9F6] relative z-[1] overflow-hidden">
            <div class="flex lg:flex-col items-end gap-[130px] xxxl:gap-[100px] xxl:gap-[60px] lg:gap-y-0 ml-[19.5%] xxxl:ml-[14.71%] xxl:ml-[9.71%] xl:ml-[5.71%] lg:mx-[5.71%] md:mx-[12px]">
                ...
                <div class="py-[120px] xl:py-[80px] md:py-[60px]">
                    ...
                    <ul class="ed-inner-about-list font-medium text-[16px] text-black grid grid-cols-2 xxs:grid-cols-1 gap-x-[30px] xxs:gap-x-[15px] gap-y-[9px] mb-[46px] *:pl-[25px] *:relative *:before:absolute *:before:left-0 *:before:top-[4px] *:before:w-[15px] *:before:aspect-square *:before:bg-[url(../{{asset('img/icon/checkmark.s')}}vg)] *:before:bg-no-repeat *:before:bg-[length:15px_13px] *:before:bg-center">
                ...
                <div class="relative shrink-0 xxxl:max-w-[55%] lg:max-w-full">
                    <img src="{{asset('img/employability-img.jpg')}}" alt="image" class="min-h-[280px]">
            ...
            <!-- vector -->
            <img src="{{asset('img/employability-vector.svg')}}" alt="vector" class="absolute -z-[1] bottom-[186px] left-[37px] pointer-events-none">
        </section>
                ...
                <div class="ed-program-slider swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <!-- img -->
                            <div class="mb-[30px]">
                                <img src="{{asset('img/program-1.jpg')}}" alt="image">
                            </div>
                        ...
                        <div class="swiper-slide">
                            <!-- img -->
                            <div class="mb-[30px]">
                                <img src="{{asset('img/program-2.jpg')}}" alt="image">
                            </div>
                        ...
                        <div class="swiper-slide">
                            <!-- img -->
                            <div class="mb-[30px]">
                                <img src="{{asset('img/program-3.jpg')}}" alt="image">
                            </div>
        ...
        <section class="bg-edpurple relative z-[1] overflow-hidden">
            <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                <div class="flex md:flex-col items-center gap-[60px] lg:gap-[40px] md:gap-y-[20px]">
                    ...
                    <div class="shrink-0 relative z-[1] pr-[40px] lg:pr-0">
                        <img src="{{asset('img/cta-img.png')}}" alt="image">
                        <img src="{{asset('img/cta-img-vector.svg')}}" alt="vector" class="absolute right-[0] lg:right-[-40px] top-[20px] -z-[1] max-w-[460px]">
                    </div>
                </div>
            </div>
            ...
            <!-- vector -->
            <div>
                <img src="{{asset('img/cta-vector-1.png')}}" alt="vector" class="absolute -z-[1] bottom-0 left-0 pointer-events-none">
                <img src="{{asset('img/cta-vector-2.png')}}" alt="vector" class="absolute -z-[1] top-0 right-0 pointer-events-none">
            </div>
        </section>
        <!-- CTA SECTION END -->
            ...
            <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                <div class="flex md:flex-col items-start gap-y-[40px]">
                    ...
                    <div class="max-w-[50%] md:max-w-full">
                        <!-- heading -->
                        <div class="pb-[40px] sm:pb-[20px] bg-[url('{{asset('img/testimonial-heading-vector.svg')}})] bg-no-repeat bg-left-bottom bg-[length:1000px] mb-[40px]  md:bg-none md:mb-0">
                        ...
                        <div class="flex xxs:flex-col gap-[15px] items-center relative pr-[35px]">
                            ...
                            <!-- slider dots -->
                            <div class="flex items-start flex-col xxs:hidden shrink-0 space-y-[40px] relative z-[1] before:absolute before:top-[50%] before:-translate-y-[50%] before:right-[28px] before:w-[138px] before:h-[420px] before:bg-[url('{{asset('img/testimonial-img-')}}slider-vector.svg')] before:bg-no-repeat before:bg-center before:bg-[length:100%_100%] before:-z-[1] before:opacity-10 before:pointer-events-none">
                                <div class="rounded-full overflow-hidden inline-block border border-edpurple p-[5px] even:ml-[40px]">
                                    <img src="{{asset('img/user-2.png')}}" alt="user" class="rounded-full w-[90px] aspect-square">
                                </div>
                                <div class="rounded-full overflow-hidden inline-block border border-edpurple p-[5px] even:ml-[40px]">
                                    <img src="{{asset('img/user-3.png')}}" alt="user" class="rounded-full w-[90px] aspect-square">
                                </div>
                                <div class="rounded-full overflow-hidden inline-block border border-edpurple p-[5px] even:ml-[40px]">
                                    <img src="{{asset('img/user-4.png')}}" alt="user" class="rounded-full w-[90px] aspect-square">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <!-- heading -->
                        <div class="pb-[40px] sm:pb-[20px] flex justify-end md:justify-start bg-[url('../{{asset('img/testimonial-head')}}ing-vector.svg')] bg-no-repeat bg-right-bottom bg-[length:1000px] mb-[40px] md:bg-none md:mb-0">
                            <div>
